...
[TestFixture]
internal class AddStudentCommandValidatorTests
{
    private AddStudentCommandValidator _validator;

    private static AddStudentCommand CreateValidModel =>
        new(
            "ID12345",
            "John",
            "Doe",
    ...
    public void SetUp()
    {
        _validator = new AddStudentCommandValidator();
    }
